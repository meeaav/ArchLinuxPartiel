...
#Monter /dev/sda1 sur /boot (en dehors de /mnt pour pas qu'il soit chiffré)
mkdir -p /boot
mount /dev/sda1 /boot
...
#Synchronisation des miroirs pour pacman
reflector --country France --age 12 --protocol https --sort rate --save /etc/pacman.d/mirrorlist

#Installation de la base Linux
pacstrap -K /mnt base linux linux-firmware lvm2

#Génération du fichier fstab, servant à monter les partitions au démarrage
...
#Régénérer l'initramfs pour prendre en compte les modifications
